package com.sparta.springcore.integraiton;
...
public class UserProductIntegrationTest {
    ...
    void test1() {
        ...
        // then
        assertThat("Id가 유효하지 않습니다!").isEqualTo(exception.getMessage());
    }
    ...
    void test2() {
        ...
        requestDto.setAdminToken(adminToken);
        ...
        assertThat(UserRoleEnum.USER).isEqualTo(user.getRole());
    }
